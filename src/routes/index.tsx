  ...
  return <Page>
    ...
    <section className="grid gap-5 lg:grid-cols-[1.5fr_1fr]">
      ...
      <Surface className="flex flex-col justify-between">
        ...
        <div className="mt-8"><div className="mb-2 flex justify-between text-sm"><span>Mastery</span><strong>72%</strong></div><ProgressBar value={72} /><Button asChild variant="ghost" className="mt-4 px-0 text-primary"><Link to="/material/" params={{ materialId: "tiu-4" }}>Continue <ArrowRight /></Link></Button></div>
      </Surface>
    </section>
